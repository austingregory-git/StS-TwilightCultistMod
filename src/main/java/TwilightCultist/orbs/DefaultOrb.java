...
import static TwilightCultist.TwilightCultistMod.makeOrbPath;

public class DefaultOrb extends CustomOrb {

    // Standard ID/Description
    public static final String ORB_ID = TwilightCultistMod.makeID("DefaultOrb");
