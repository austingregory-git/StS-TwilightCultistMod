...
public abstract class AbstractPhase {
    ...
    public static com.megacrit.cardcrawl.orbs.AbstractOrb getRandomOrb(boolean useCardRng) {
        ArrayList<com.megacrit.cardcrawl.orbs.AbstractOrb> orbs = new ArrayList();
        orbs.add(new Dark());
        orbs.add(new Frost());
        orbs.add(new Lightning());
        orbs.add(new Plasma());
        return useCardRng ? (com.megacrit.cardcrawl.orbs.AbstractOrb)orbs.get(AbstractDungeon.cardRandomRng.random(orbs.size() - 1)) : (com.megacrit.cardcrawl.orbs.AbstractOrb)orbs.get(MathUtils.random(orbs.size() - 1));
    }
